...
export class Backend implements backendInterface {
    ...
    async createScheduleEntry(arg0: string, arg1: bigint | null, arg2: string, arg3: string, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createScheduleEntry(arg0, to_candid_opt_n3(this._uploadFile, this._downloadFile, arg1), arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createStory(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: bigint | null, arg6: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createStory(arg0, arg1, arg2, arg3, arg4, to_candid_opt_n4(this._uploadFile, this._downloadFile, arg5), arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteStory(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getStoriesByStatus(arg0: string): Promise<Array<Story>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStoriesByStatus(arg0);
                return from_candid_vec_n5(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateScheduleEntry(arg0: bigint, arg1: string, arg2: bigint | null, arg3: string, arg4: string, arg5: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.updateScheduleEntry(arg0, arg1, to_candid_opt_n3(this._uploadFile, this._downloadFile, arg2), arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateStory(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: bigint | null, arg7: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.updateStory(arg0, arg1, arg2, arg3, arg4, arg5, to_candid_opt_n4(this._uploadFile, this._downloadFile, arg6), arg7);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        deadline: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.deadline)),
